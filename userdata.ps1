...
Install-Module -Name StorageDsc -Verbose -Force

Configuration EbsVolumeInit
{
    Import-DSCResource -ModuleName StorageDsc

    WaitForDisk EbsDisk1
    {
        DiskId = 1
        RetryIntervalSec = 30
        RetryCount = 60 
    ...
    Disk Volume1
    {
        ...
        DriveLetter = 'H'
        Size = '3328581824512'
        DependsOn = '[WaitForDisk]EbsDisk1'
    }

    WaitForDisk EbsDisk2
    {
        DiskId = 2
        RetryIntervalSec = 30
        RetryCount = 60
    ...
    Disk Volume2
    {
        ...
        DriveLetter = 'I'
        Size  = '3328581824512'
        DependsOn = '[WaitForDisk]EbsDisk2'
    }
...
EbsVolumeInit
Start-DSCConfiguration -Path .\EbsVolumeInit -Verbose -Wait -Force
